...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 shadow-sm hover:shadow-md px-5 py-2.5",
  secondary:
...
const Button = ({
  ...
  const baseStyles = [
    "inline-flex items-center justify-center cursor-pointer", // Aligns icons if you add them later
    "text-sm font-semibold", // Professional buttons usually use 14px-16px
    "px-3 py-2 rounded-lg", // Modern "squircle" rounding
